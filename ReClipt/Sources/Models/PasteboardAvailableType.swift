...
enum PasteboardAvailableType: String, Equatable, CaseIterable {
    ...
    static func availableTypes(
        ...
        let uniquePasteboardTypes = Array(Set(pasteboardTypes))
        return pasteboardTypes.compactMap { pasteboardType -> NSPasteboard.PasteboardType? in
...
private extension NSPasteboard.PasteboardType {
    ...
    func isCovered(by pasteboardTypes: [NSPasteboard.PasteboardType]) -> Bool {
        switch self {
